...
<div id="ariane">
	<p>Vous êtes ici : <a href="live.php">Recherche lives</a></p>
</div>
...
<?php include('includes/champrecherche.php'); ?>
	...
	<div id="rechercheavancee">
		...
		<form id="formavance" action="resultatlive.php" method="GET">
			<fieldset class="souscat">
				<legend>Rechercher dans les live</legend>
	...
	<section>
	<a href="live.php"><div id="btnscrollinfini">Retour à tous les articles de la catégorie "lives"</div></a>
    ...
    if($recherche == null && $lettre==null && $mois==null && $annee==null){
        echo '<center><p>Veuillez au moins remplir un champ de recherche.<br/><a href="live.php">Afficher tout les articles dans la catégorie live.</a></p><br/><br/></center>';
    }else{
        $sql = "SELECT id_event,_id_type_indiv,txt,nom FROM evenement_individuel WHERE _id_type_indiv =8 AND";
