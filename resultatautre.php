...
<title></title>
<meta description="Les photographies d'ArtEos prises lors de autre.">
</head>
<?php include('includes/header.php'); ?>
<?php include('includes/slider.php'); ?>
<div id="ariane">
<p>Vous êtes ici : <a href="resultat.php">Recherche autres :</a></p>
</div>
...
<hr>
<form id="formavance" action="resultatautre.php" method="GET">
    <fieldset class="souscat">
        <legend>Rechercher dans les autres</legend>
...
<section>
   <a href="autres.php"><div id="btnscrollinfini">Retour à tous les articles de la catégorie "autres"</div></a>
    <?php
    $recherche ="";
    $lettre ="";
    $mois="";
    ...
    echo '<center><p>Veuillez au moins remplir un champ de recherche.<br/><a href="autres.php">Afficher tout les articles dans la catégorie autre.</a></p><br/><br/></center>';
    }else{
    $sql = "SELECT id_event,_id_type_indiv,txt,nom FROM evenement_individuel WHERE _id_type_indiv =18 AND";
