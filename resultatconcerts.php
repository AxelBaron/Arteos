...
<div id="ariane">
	<p>Vous êtes ici : <a href="resultat.php">Recherche concert</a></p>
</div>
...
<?php include('includes/champrecherche.php'); ?>
	...
	<div id="rechercheavancee">
		...
		<form id="formavance" action="resultatconcerts.php" method="GET">
			<fieldset class="souscat">
				<legend>Rechercher dans les concerts :</legend>
        		<input type="search" placeholder="Rechercher un concert, artiste..." name="recherche" />
	...
	<section>
	<a href="concerts.php"><div id="btnscrollinfini">Retour à tous les articles de la catégorie "concerts"</div></a>
    ...
    if($recherche == null && $lettre==null && $mois==null && $annee==null){
       echo '<center><p>Veuillez au moins remplir un champ de recherche.<br/><a href="concerts.php">Afficher tout les articles dans la catégorie concert.</a></p><br/><br/></center>';
    }else{
        $sql = "SELECT id_event,_id_type_indiv,txt,nom FROM evenement_individuel WHERE _id_type_gp =4 AND";
