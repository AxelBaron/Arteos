...
<?php include('includes/head.php'); ?>
	<title></title>
	<meta description="Les photographies d'ArtEos prises lors d'acoustique.">
</head>
...
<div id="ariane">
	<p>Vous êtes ici : <a href="live.php">Recherche d'acoustiques</a></p>
</div>
...
<?php include('includes/champrecherche.php'); ?>
	...
	<div id="rechercheavancee">
		...
		<form id="formavance" action="resultatacoustique.php" method="GET">
			<fieldset class="souscat">
				<legend>Rechercher dans les acoustiques</legend>
	...
	<section>
	<a href="acoustique.php"><div id="btnscrollinfini">Retour à tous les articles de la catégorie "acoustiques"</div></a>
    ...
    if($recherche == null && $lettre==null && $mois==null && $annee==null){
        echo '<center><p>Veuillez au moins remplir un champ de recherche.<br/><a href="acoustique.php">Afficher tout les articles dans la catégorie acoustique.</a></p></center>';
    }else{
        $sql = "SELECT id_event,_id_type_indiv,txt,nom FROM evenement_individuel WHERE _id_type_indiv =2 AND";
