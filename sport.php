...
<div id="ariane">
	<p>Vous êtes ici : Photos > <a href="concerts.php">Sports</a></p>
</div>
<?php include('includes/reseauxsociaux.php'); ?>
<?php include('includes/champrecherche.php'); ?>
<script src="js/scrollPlusSport.js"></script>
	...
	<section class='recepteur'>
		...
		$sql="SELECT * FROM evenement_individuel WHERE _id_type_gp = 5  ORDER BY id_event DESC LIMIT 12";
		$liste = $pdo->query($sql);
		while ($data= $liste->fetch()) {
	...
	<div id="btnscrollinfini" onClick="scrollPlusSport()">Afficher plus d'articles</div>
