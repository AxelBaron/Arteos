...
<?php include('includes/head.php'); ?>
	<title>Les autres couverts par ArtEos</title>
...
<div id="ariane">
	<p>Vous êtes ici : Photos > <a href="autre.php">Autre</a></p>
</div>
<?php include('includes/reseauxsociaux.php'); ?>
<?php include('includes/champrecherche.php'); ?>
<script src="js/scrollPlusAutres.js"></script>
	...
	<section class='recepteur'>
		...
		$sql="SELECT * FROM evenement_individuel WHERE _id_type_indiv = 18 ORDER BY id_event DESC LIMIT 12";
		$liste = $pdo->query($sql);
        ...
        $sql="SELECT * FROM evenement_individuel WHERE _id_type_indiv = 18 ORDER BY id_event DESC";
		$liste = $pdo->query($sql);
        $data= $liste->fetch();
        if($data == null){
	...
	<div id="btnscrollinfini" onClick="scrollPlusAutres()">Afficher plus d'articles</div>
